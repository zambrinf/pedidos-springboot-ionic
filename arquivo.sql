...
INSERT INTO `cliente` VALUES (1,'33333333333','maria@gmail','Maria Silva',1);
...
INSERT INTO `endereco` VALUES (1,'jardim','38241456','ap 101','Rua flores','100',1,1),(2,'Centro','3423432','sala 501','av matos','102',2,1);
...
CREATE TABLE `produto_categoria` (
  ...
  `cat_id` int NOT NULL,
  KEY `FK8maxwmores4211mdd8oc4ic05` (`cat_id`),
  KEY `FKhcbcm0g8w6e0cj9k9no2v8hgh` (`prod_id`),
  CONSTRAINT `FK8maxwmores4211mdd8oc4ic05` FOREIGN KEY (`cat_id`) REFERENCES `categoria` (`id`),
  CONSTRAINT `FKhcbcm0g8w6e0cj9k9no2v8hgh` FOREIGN KEY (`prod_id`) REFERENCES `produto` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `telefone` VALUES (1,'33223322'),(1,'33222335');
...
-- Dump completed on 2020-11-01 16:55:42
